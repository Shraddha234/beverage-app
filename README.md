...
1) The application should have 2 main views. The first view needs to show a beverage menu and a queueing system for customers. 
2) The second view needs to display a simple form where customers can place an order for a beverage and submit it. Once orders are submitted, they should appear in the queue. 
1) Beverage menu 
...
3) Beverage order form 
The beverage order form is a simple form that should allow the customer to select a drink from the menu and submit it along with their name to identify themselves. 
